-- x402-Base Basic | Author: Richard Patterson (@De-ASI-INTERFACE)
...
theorem base_replay_prevented (a : PaymentAuth) (s : FacilitatorState) (h : verify a s)
    : a.nonce ∉ s.used_nonces := h.1

theorem base_not_expired (a : PaymentAuth) (s : FacilitatorState) (h : verify a s)
