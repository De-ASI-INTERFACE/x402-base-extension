-- ============================================================
-- x402-Base: Aerodrome Finance v2 Routing Invariants
...
namespace X402Base.Aerodrome

structure Pool where
  token0 : Nat; token1 : Nat
  stable : Bool  -- stable vs volatile pool
  deriving Repr
